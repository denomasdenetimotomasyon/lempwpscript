...
mv /tmp/wordpress/* /var/www/html/denomas.com/


chown -R www-data: /var/www/html/denomas.com
...
echo "server {
  listen 80;
  listen [::]:80;
  server_name www.denomas.com denomas.com;
  root /var/www/html/denomas.com/;
...
ln -s /etc/nginx/sites-available/denomas.com /etc/nginx/sites-enabled/
sleep 1
...
echo "-----Open your browser and type denomas.com-----"
echo -e "\033[0m"
