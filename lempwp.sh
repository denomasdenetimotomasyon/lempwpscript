...
mv /tmp/wordpress/* /var/www/html/docs.denomas.com/


chown -R www-data: /var/www/html/docs.denomas.com

cd /etc/nginx/sites-available

touch docs.denomas.com

echo "server {
  listen 80;
  listen [::]:80;
  server_name www.docs.denomas.com docs.denomas.com;
  root /var/www/html/docs.denomas.com/;
...
cd /var/www/html/docs.denomas.com
...
ln -s /etc/nginx/sites-available/docs.denomas.com /etc/nginx/sites-enabled/
sleep 1
...
echo "-----Open your browser and type docs.denomas.com-----"
echo -e "\033[0m"
